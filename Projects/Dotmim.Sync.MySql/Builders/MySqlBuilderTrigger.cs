...
namespace Dotmim.Sync.MySql
{
    public class MySqlBuilderTrigger : IDbBuilderTriggerHelper
    {
        ...
        private string DeleteTriggerBodyText()
        {
            ...
            if (this.Filters != null)
            {
                ...
                foreach (var filterColumn in this.Filters)
                {
                    ...
                    ObjectNameParser columnName = ObjectNameParser.Create(filterColumn.ColumnName.ToLowerInvariant(), "`", "`");
        ...
        private string InsertTriggerBodyText()
        {
            ...
            {
                ObjectNameParser columnName = ObjectNameParser.Create(mutableColumn.ColumnName.ToLowerInvariant(), "`", "`");
